    ...
    <div class="container"><!-- container -->
        <div class="wrapContent"><!-- wrapContent -->
            <div class="wrap__content">
                <?php
                $MenuController = config('book_a_function.set_b');
                foreach ($MenuController["name_topic"] as $name_topic) {
                    ?>
                ...
                <div class="wrap__name__menu">
                    ...
                    <?php
                foreach ($MenuController["name_sub"][$name_topic] as $name_sub) {
                    ?>
                <div class="wrap__sub__menu">
                    ...
                    <p>
                            <?= $MenuController["detail_sub"][$name_topic][$name_sub] ?>
                    </p>
                </div>
                    <?php
                }
